...
if __name__ == "__main__":
    ...
    # yolov5_wrapper = YoLov5TRT('./traffic_signs_640s_7_0.engine', './libmyplugins.so', classes)
    # yolov5_wrapper = YoLov5TRT('./garbage_classification_640s_7_0.engine', './libmyplugins.so', classes)
    yolov5_wrapper = YoLov5TRT('./yolov5s.engine', './libmyplugins.so', classes)
